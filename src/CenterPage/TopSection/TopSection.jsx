...
function TopSection() {
  return (
    <>
      <div className=" h-40 w-screen mt-25 flex gap-2 pr-2">
        ...
        <div className="bg-[#ECECEC] h-full flex-1 rounded-sm shadow-[0px_5px_5px_0px_rgba(0,0,0,0.5)] grid-rows-3">
        ...
        <div className="absolute flex gap-1 top-60 left-40 z-1">
          <input
            type="radio"
